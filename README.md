...
This repository contains the source code of the book ["Programming a toy computer from scratch"](https://ebruneton.github.io/toypc/toypc.pdf), and of the associated [website](https://ebruneton.github.io/toypc/) and [emulator](https://ebruneton.github.io/toypc/emulator.html).
